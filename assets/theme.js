...
slate.Variants = (function() {
  ...
  Variants.prototype = _.assignIn({}, Variants.prototype, {
    ...
    _updatePrice: function(variant) {
      ...
      if (variantPrice === this.currentVariant.price && variant.compare_at_price === this.currentVariant.compare_at_price) {
        return;
      }
...
theme.Product = (function() {
  ...
  function Product(container) {
    ...
    this.selectors = {
      ...
      bottomPhotoFeaturedImage: '.PhotoImg-' + sectionId,
      bottomImageWrap: '.PhotoLink-' + sectionId
    };
...
//       this._productThumbnailSlider();
    ...
    _updatePrice: function(evt) {
      ...
      if (variant) {
        ...
        $(this.selectors.productPrice).html(theme.Currency.formatMoney(variantPrice, theme.moneyFormat));
    ...
    _photoZoomImage: function() {
      if (!$(this.selectors.bottomPhotoFeaturedImage).length) {
        return;
      }
...
$('.additional-slider-wrapper').slick({
  infinite: true,
  dots: true,
  speed: 500,
  fade: true,
...
$('.product-slider-wrapper .three-image-inner-wrapper').slick({
  infinite: true,
  slidesToShow: 3,
  slidesToScroll: 1,
  responsive: [
...
$('.product-slider-wrapper .two-image-inner-wrapper').slick({
  infinite: true,
  slidesToShow: 2,
  slidesToScroll: 1,
  responsive: [
